...
export const sections: Section[] = [
  ...
  },
  {
    ...
    icon: "🤖",
    resources: [
      { title: "Agent QA – Self-Improving QA Agent", url: "https://github.com/vostride/agent-qa", description: "Runs natural-language web and mobile tests with persistent memory and UI-change adaptation", badge: "NEW" },
